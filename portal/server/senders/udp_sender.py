...
class UDPSenderManager:
    ...
    def start_server(self):
        ...
        print(f"UDP sender started for connection uuid: {self.uuid}, name: {self._connection.name}")

    def stop_server(self):
        self._shutdown_event.set()
        if self._server_thread:
            self._server_thread.join()
        print(f"UDP sender stopped for connection uuid: {self.uuid}, name: {self._connection.name}")
